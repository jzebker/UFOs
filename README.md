...
<p align="center">
  ...
  <figcaption style="font-size:8px">Durations are not reported in consistent format and various typos exist in the data.  Defined shapes do not always correspond to the same shape.</figcaption>
</p>
